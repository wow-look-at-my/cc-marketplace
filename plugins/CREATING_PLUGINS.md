...
1. **go-toolchain** (CI runs the `wow-look-at-my/go-toolchain@lkgb` action if any `.go` files are found — builds cross-platform binaries for linux/darwin × amd64/arm64)
