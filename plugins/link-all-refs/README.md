...
Strip every markdown link out of the closing message, then look at what is left. Anything found was never linked. A link given earlier in the message, or in an earlier turn, earns no credit -- the reader is looking at the text in front of them.
