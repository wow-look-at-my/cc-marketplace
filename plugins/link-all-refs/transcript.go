...
//
// Only the closing message counts. A URL that appeared in a tool result, a
// thinking block, or three turns ago is a URL the reader was never handed, and
// crediting it is exactly the "I linked it earlier" excuse this plugin exists
// to remove.
package main
