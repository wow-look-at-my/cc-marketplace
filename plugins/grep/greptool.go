...
// (2.1.116:cli.js:286337-286368) with four amendments: the mode-flag
...
// filenames_with_matches as well as content. An explicit regular-file target
// in filenames_with_matches mode also gains --text so rg reports a binary
// file's complete raw line consistently across platforms; directory searches
// retain rg's normal binary skipping. The permission deny-rule and
// claude-internal cache exclusions the builtin appended are not available to
// a plugin and are omitted.
