...
func TestResolveAgainst(t *testing.T) {
	assert.Equal(t, "/abs/dir", resolveAgainst("/abs/dir", "/root"))
	assert.Equal(t, "/root/rel/dir", resolveAgainst("rel/dir", "/root"))
	assert.Equal(t, "/root/x", resolveAgainst("../x", "/root/sub"))
}
