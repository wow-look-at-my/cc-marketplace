...
// plugins/common-checks/src/slopfix.ts
var import_node_child_process = require("node:child_process");
var import_node_fs = require("node:fs");
var import_node_path = require("node:path");
var import_node_url = require("node:url");
var import_meta = {};
var CANDIDATES = ["build/common-checks", "build/slopfix_cosmo_fat"];
function moduleDir() {
...
function report(relativePath2, content) {
  ...
  if (!binary) {
    throw new SlopfixUnavailable(
      "no slopfix binary beside this plugin, so nothing can be checked. The plugin ships one under build/. Set COMMON_CHECKS_SLOPFIX to point at another."
    );
  }
  let out;
  try {
...
// plugins/common-checks/src/scope.ts
