...
> Vendored verbatim from [`docker/docs/content/reference/compose-file/services.md`](https://github.com/docker/docs/blob/034d46977dac45d2a9493f2465b08108ac3cf87b/content/reference/compose-file/services.md) at commit `034d46977dac45d2a9493f2465b08108ac3cf87b`.
...
> Version-gated feature: "Compose attach". Check upstream for the minimum version.
...
> Version-gated feature: "Compose cgroup". Check upstream for the minimum version.
...
> [!NOTE]
>
> Unlike the `CMD` instruction in a Dockerfile, the `command` field doesn't automatically run within the context of the [`SHELL`](https://docs.docker.com/reference/dockerfile.md#shell-form) instruction defined in the image. If your `command` relies on shell-specific features, such as environment variable expansion, you need to explicitly run it within a shell. For example:
>
> ```yaml
> command: /bin/sh -c 'echo "hello $$HOSTNAME"'
> ```

The value can also be a list, similar to the [exec-form syntax](https://docs.docker.com/reference/dockerfile.md#exec-form)
used by the [Dockerfile](https://docs.docker.com/reference/dockerfile.md#exec-form).
...
> Version-gated feature: "Compose develop". Check upstream for the minimum version.
...
> Version-gated feature: "Compose driver opts". Check upstream for the minimum version.
...
Consult the [network drivers documentation](https://docs.docker.com/manuals/engine/network/_index.md) for more information.
...
> Version-gated feature: "Compose required". Check upstream for the minimum version.
...
> Version-gated feature: "Compose format". Check upstream for the minimum version.
...
> Version-gated feature: "Compose gpus". Check upstream for the minimum version.
...
For more information on `HEALTHCHECK`, see the [Dockerfile reference](https://docs.docker.com/reference/dockerfile.md#healthcheck).
...
> Version-gated feature: "Compose label file". Check upstream for the minimum version.
...
> Version-gated feature: "Compose models". Check upstream for the minimum version.
...
For more information container networks, see the [Docker Engine documentation](https://docs.docker.com/manuals/engine/network/_index.md#container-networks).
...
> Version-gated feature: "Compose interface-name". Check upstream for the minimum version.
...
> Version-gated feature: "Compose mac address". Check upstream for the minimum version.
...
> Version-gated feature: "Compose gw priority". Check upstream for the minimum version.
...
> Version-gated feature: "Compose post start". Check upstream for the minimum version.
...
For more information, see [Use lifecycle hooks](https://docs.docker.com/manuals/compose/how-tos/lifecycle.md).

### pre_start

> Version-gated feature: "Compose pre_start". Check upstream for the minimum version.
...
> Version-gated feature: "Compose pre stop". Check upstream for the minimum version.
...
> Version-gated feature: "Compose provider services". Check upstream for the minimum version.
...
For more information on using the `provider` attribute, see [Use provider services](https://docs.docker.com/manuals/compose/how-tos/provider-services.md).
...
The default is `runc`. To use a different runtime, see [Alternative runtimes](https://docs.docker.com/manuals/engine/daemon/alternative-runtimes.md).
...
> Version-gated feature: "Compose uts". Check upstream for the minimum version.
...
> Compose now takes advantage of [Synchronized file shares](https://docs.docker.com/manuals/desktop/features/synchronized-file-sharing.md) and automatically creates file shares for bind mounts.
