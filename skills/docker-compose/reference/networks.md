...
> Vendored verbatim from [`docker/docs/content/reference/compose-file/networks.md`](https://github.com/docker/docs/blob/fd5e73c9183cc2e1600a747a52aaf3d8ea0ce3b5/content/reference/compose-file/networks.md) at commit `fd5e73c9183cc2e1600a747a52aaf3d8ea0ce3b5`.
...
For more information on drivers and available options, see [Network drivers](https://docs.docker.com/manuals/engine/network/drivers/_index.md).
...
> Version-gated feature: "Compose enable ipv4". Check upstream for the minimum version.
...
For more examples, see [Networking in Compose](https://docs.docker.com/manuals/compose/how-tos/networking.md).
