...
> Vendored verbatim from [`docker/docs/content/reference/compose-file/merge.md`](https://github.com/docker/docs/blob/ff96ad1711065cf2e9c3f1d701dad04775834f70/content/reference/compose-file/merge.md) at commit `ff96ad1711065cf2e9c3f1d701dad04775834f70`.
...
> Version-gated feature: "Compose replace file". Check upstream for the minimum version.
...
For more information on how merge can be used to create a composite Compose file, see [Working with multiple Compose files](https://docs.docker.com/manuals/compose/how-tos/multiple-compose-files/_index.md)
