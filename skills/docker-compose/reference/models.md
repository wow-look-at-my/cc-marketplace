...
> Vendored verbatim from [`docker/docs/content/reference/compose-file/models.md`](https://github.com/docker/docs/blob/938f943d945d222a29f8615cadf03ff536f895a8/content/reference/compose-file/models.md) at commit `938f943d945d222a29f8615cadf03ff536f895a8`.
...
For more examples and information on using `model`, see [Use AI models in Compose](https://docs.docker.com/manuals/compose/how-tos/models-and-compose.md)