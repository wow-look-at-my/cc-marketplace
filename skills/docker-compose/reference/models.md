...
> Vendored verbatim from [`docker/docs/content/reference/compose-file/models.md`](https://github.com/docker/docs/blob/ff96ad1711065cf2e9c3f1d701dad04775834f70/content/reference/compose-file/models.md) at commit `ff96ad1711065cf2e9c3f1d701dad04775834f70`.
...
For more examples and information on using `model`, see [Use AI models in Compose](https://docs.docker.com/manuals/ai/compose/models-and-compose.md)