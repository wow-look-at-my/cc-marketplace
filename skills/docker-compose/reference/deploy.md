...
> Vendored verbatim from [`docker/docs/content/reference/compose-file/deploy.md`](https://github.com/docker/docs/blob/fd5e73c9183cc2e1600a747a52aaf3d8ea0ce3b5/content/reference/compose-file/deploy.md) at commit `fd5e73c9183cc2e1600a747a52aaf3d8ea0ce3b5`.
