...
> Vendored verbatim from [`docker/docs/content/reference/compose-file/include.md`](https://github.com/docker/docs/blob/ff96ad1711065cf2e9c3f1d701dad04775834f70/content/reference/compose-file/include.md) at commit `ff96ad1711065cf2e9c3f1d701dad04775834f70`.
> Licensed Apache-2.0. Regenerate with `go run ./tools/vendor-docker-docs`.

> Version-gated feature: "Composefile include". Check upstream for the minimum version.
...
For more information on using `include`, see [Working with multiple Compose files](https://docs.docker.com/manuals/compose/how-tos/multiple-compose-files/_index.md)
